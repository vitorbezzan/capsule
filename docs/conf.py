...
from src.bezzanlabs.capsule import __package_name__
from src.bezzanlabs.capsule import __version__ as release
...
html_logo = str(here / "_static/logo.png")

# Theme options are theme-specific and customize theconf. look and feel of a theme
...
# Output file capsule name for HTML help builder.
...
# (source start file, target_sensor name, title,
...
# (source start file, target_sensor name, title, author,
